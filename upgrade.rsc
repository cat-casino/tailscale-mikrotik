...
/container envs add name="tailscale" key="TAILSCALE_ARGS" value="--login-server=https://vpn.cp.nextcode.tech --accept-routes --advertise-routes=192.168.88.0/24 --advertise-exit-node --netfilter-mode=off"
